  ...
  describe("SignUpPageTesting", () => {
    ...
    test("handles user input and form submission successfully", async () => {
      ...
      test("failed singup", async () => {
        fetch.mockRejectedValueOnce(new Error("user already exists"));
